      ...
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <font style="vertical-align: inherit;">
            <font style="vertical-align: inherit;"><i class="fa fa-bug"></i>&nbsp Crud</font>
          </font>
        </a>
              ...
              <?php if (!$RoleUser): ?>
                <li class="nav-item">
                  <a class="nav-link" href="#">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Админ. панель</font>
                    </font>
                  </a>
                </li>
              <?php else: ?>
                <li class="nav-item">
                  <a class="nav-link" href="#">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Заявки</font>
                    </font>
                  </a>
                </li>
              <?php endif; ?>
        ...
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
          ...
          <?php if ($isAuthenticated): ?>
            <?php if ($RoleUser): ?> <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Заявки</a></li> <?php else: ?>
              <li class="nav-item">
                <a class="nav-link px-2 text-body-secondary" href="#">Админ. панель</a>
              </li>
            <?php endif; ?>
          <?php endif; ?>
